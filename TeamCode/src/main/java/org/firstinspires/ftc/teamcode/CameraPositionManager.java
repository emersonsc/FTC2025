...
public class CameraPositionManager {
    ...
    private static final double APRILTAG_POSITION = 0.8;   // Looking up/forward for AprilTags
    private static final double OBELISK_POSITION = 0.6;    // Angled to see obelisk
    private static final double INTAKE_POSITION = 0.2;     // Looking down at intake path
